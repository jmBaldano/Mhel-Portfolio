<template>
    <body class="">
        ...
        <section class="flex justify-start">
            ...
            <div class="p-20 pl-50 border-r-3 border-amber-300">
                <h2 class="text-2xl md:text4xl uppercase font-thin text-amber-700 pb-5">A little info about me</h2>
                 <p class="text-[#CD2C58] leading-relaxed font-sans whitespace-pre-wrap md:w-[800px] w-[300px] md:text-xl text-sm text-justify">
